  ...
  <table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
          ...
          <td button href="infoPerusahaan.php" type="submit" class="btn btn-primary">Mendaftar</button></td>
        ...
        <a button   href="../loginAlumni/index.php" type="submit" style="float:left;" class="btn btn-primary">Home </button> </a>
      <?php } ?>
    </tbody>
  </table>
</div>
