...
<div class="container">
  ...
  ?>
  <h2>info data
  <a href="TambahUmum.php" class="btn btn-primary" style="float:right;">tambah data baru</a>
  </h2>
    ...
    <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="indexUmum.php?deleteId=<?php echo $umum['id'] ?>" style="color:red" onclick="confirm('apa anda yakin ingin menghapus data ini')">
