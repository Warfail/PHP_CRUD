...
<div class="container">
  ...
  <div class="dropdown-menu" >
    <a class="dropdown-item" href="../alumni/indexAlumni.php">Alumni</a>
    <a class="dropdown-item" href="../mahasiswa/indexMahasiswa.php">Mahasiswa</a>
    <a class="dropdown-item" href="../UMUM/indexUmum.php">Umum</a>
    <a class="dropdown-item" href="../perusahaan/indexPerusahaan.php">Perusahaan</a>
...
<a button   href="userAccount.php?logoutSubmit=1" type="submit" style="float:right;" class="btn btn-primary">Logout </button> </a>
   ...
   <ul class="breadcrumb">
    ...
    <?php }else{ ?>
        ...
        <div class="card fat">
						<div class="card-body">
							<h4 class="card-title text-center">MASUK SEBAGAI ADMIN</h4>
    ...
    <div class="form-group">
        ...
        <p>belum punya akun? <a href="registration.php">Silahkan request akun admin</a></p>
