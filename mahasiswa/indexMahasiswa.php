...
<div class="container">
  ...
  ?>
  <h2>Data Tersedia
  <a href="tambahMahasiswa.php" class="btn btn-primary" style="float:right;">Tambah data baru</a>
  </h2>
    ...
    <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="indexMahasiswa.php?deleteId=<?php echo $mahasiswa['nim'] ?>" style="color:red" onclick="confirm('apa anda yakin ingin menghapus data ini?')">
