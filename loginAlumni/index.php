...
<div class="container">
  ...
  <div class="dropdown-menu" >
    <a class="dropdown-item" href="../alumni/indexAlumniSingle.php">Alumni</a>
    <a class="dropdown-item" href="../alumni/TambahAlumniSingle.php">Registrasi Alumni</a>
    <a class="dropdown-item" href="../perusahaan/applyPerusahaanA.php">Info Perusahaan</a>
...
<a button   href="userAccount.php?logoutSubmit=1" type="submit" style="float:right;" class="btn btn-primary">Logout </button> </a>
   ...
   <ul class="breadcrumb">
    ...
    <?php }else{ ?>
        ...
        <div class="card fat">
						<div class="card-body">
							<h4 class="card-title text-center">MASUK SEBAGAI ALUMNI</h4>
