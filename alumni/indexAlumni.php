...
<div class="container">
  ...
  ?>
  <h2>Info Data
    <a href="tambahAlumni.php" class="btn btn-primary" style="float:right;">Tambahkan data baru</a>
    ...
    <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="indexAlumni.php?deleteId=<?php echo $alumni['nim'] ?>" style="color:red" onclick="confirm('Apa anda yakin ingin menghapus data ini?')">
